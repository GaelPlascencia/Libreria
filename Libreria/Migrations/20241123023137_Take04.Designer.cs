...
namespace Libreria.Migrations
{
    ...
    [Migration("20241123023137_Take04")]
    partial class Take04
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibroPedidoCliente", b =>
                {
                    b.Property<int>("LibrosId")
                        .HasColumnType("int");

                    b.Property<int>("PedidoClientesId")
                        .HasColumnType("int");

                    b.HasKey("LibrosId", "PedidoClientesId");

                    b.HasIndex("PedidoClientesId");

                    b.ToTable("LibroPedidoCliente");
                });
            ...
            modelBuilder.Entity("LibroPedidoCliente", b =>
                {
                    ...
                    b.HasOne("Libreria.Models.PedidoCliente", null)
                        .WithMany()
                        .HasForeignKey("PedidoClientesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
